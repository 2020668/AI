...
def knncls():
    ...
    # 把时间戳特征删除  返回数据的第一个是place_id的count
    ...
    tf = place_count[place_count.row_id > 3].reset_index()      # 次数大于3的保留下来 重置索引
    # 筛选
    ...
    # 进行算法流程
    knn = KNeighborsClassifier(n_neighbors=5)       # 5可以调整以获取最优值
    ...
    #
    # # 得出准确率
    # print("预测准确率:{}%".format(knn.score(x_test, y_test)*100))
